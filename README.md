...
Linux LPE Exposure Scan is a fast, authenticated SSH scanner for identifying Linux hosts that probably need follow-up for three local privilege escalation exposure checks:
...
## Installation
  ...
  2. Clone this repository:
    ...
    git clone https://github.com/BenjaminIheukumere/LinuxLPEScanner
    cd LinuxLPEScanner
...
Linux LPE Exposure Scan is a multithreaded authenticated scanner for quickly identifying Linux hosts that probably need follow-up for selected local privilege escalation exposures.
